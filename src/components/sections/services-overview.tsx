          ...
          {servicePillars.map((pillar) => (
            <RevealItem key={pillar.id}>
              <Link
                ...
                className="group flex h-full flex-col rounded-3xl glass p-8 transition-all duration-300 hover:-translate-y-1.5 hover:border-ink/20 hover:shadow-glow"
              >
                ...
                <h3 className="mt-5 font-display text-2xl font-bold text-ink">{pillar.name}</h3>
                ...
                <span className="mt-8 flex items-center gap-1.5 text-sm font-semibold text-ink">
