...
export function ResourceCard({ resource }: { resource: Resource }) {
  ...
  return (
    <div className="group flex h-full flex-col rounded-3xl glass p-7 transition-all duration-300 hover:-translate-y-1.5 hover:border-ink/20 hover:shadow-glow">
      <div className="flex items-center justify-between">
        <span className="inline-flex items-center gap-1.5 rounded-full bg-ink/[0.06] px-3 py-1 text-[11px] font-semibold uppercase tracking-wide text-mist-300">
      ...
      <div className="mt-6 flex items-center justify-between border-t border-ink/[0.07] pt-4">
        ...
        <Link
          ...
          className="flex items-center gap-1 text-xs font-semibold text-ink transition-colors group-hover:text-cyan-300"
        >
